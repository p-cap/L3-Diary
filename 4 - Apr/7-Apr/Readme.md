# Errno Codes from socket.connect_ex's return

### Errno.py
- prints the list of the error code and it's corresponding meaning, however, we need to make it more readable
```
import os
import errno
...
### errno-parser.sh
- this shell script makes it more readable
```
#!/bin/bash

echo "=================================================="
echo "List of Errno Codes and it's meaning"
echo "I created this script to identify the errno values returned from socket.connect_ex()"
...
- The error code will help me utilize the socket.connect_ex function so I know what code is being returned
